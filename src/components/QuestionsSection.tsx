...
const CATEGORIES: QuestionCategory[] = [
  ...
  },
  {
    id: "santan",
    title: "Santan & Family",
    hindiTitle: "संतान और परिवार",
    badge: "Santan Yog",
    badgeColor: "bg-green-50 text-green-700 border-green-200/80",
    icon: Heart,
    iconGradient: "from-green-500 via-emerald-500 to-green-600 text-white shadow-green-500/25",
    cardBg: "bg-gradient-to-br from-white via-[#F0FFF4] to-[#DCFCE7]/40",
    cardBorder: "border-green-100/80 hover:border-green-300",
    glowHover: "hover:shadow-green-500/10",
    topGradient: "from-green-500 via-emerald-500 to-green-600",
    questions: [
      "Bacha hone mein delay kyun ho raha hai?",
      "Santan prapti ka yog kab banega?",
      "Pregnancy mein baar-baar rukawat kyun aa rahi hai?",
    ],
  },
  {
    id: "direction",
